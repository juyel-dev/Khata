...
export const translations = {
  en: {
    ...
    deleteAccountSignInFirst: 'Sign in first to delete your account.',
    deleteAccountWarningTitle: 'This cannot be undone',
    deleteAccountWarningBody:
      'This will permanently delete your account, all cloud-synced khata and transaction data, and clear this device\u2019s local data. There is no recovery after this.',
  ...
  bn: {
    ...
    deleteAccountSignInFirst: 'অ্যাকাউন্ট মুছতে আগে লগইন করুন।',
    deleteAccountWarningTitle: 'এটা আর ফেরানো যাবে না',
    deleteAccountWarningBody:
      'এতে তোমার অ্যাকাউন্ট, ক্লাউডে থাকা সব খাতা ও লেনদেনের ডেটা, এবং এই ডিভাইসের local ডেটা সম্পূর্ণভাবে মুছে যাবে। এরপর আর কিছু ফেরত পাওয়া যাবে না।',
    confirmPassword: 'পাসওয়ার্ড নিশ্চিত করুন',
    typeDeleteToConfirm: 'নিশ্চিত করতে DELETE লিখুন',
    deleteAccountConfirmButton: 'আমার অ্যাকাউন্ট চিরতরে মুছে দিন',
